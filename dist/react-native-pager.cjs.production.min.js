...
function L(e) {
  var t,
    ...
    x = W(E(s, v)),
    w = W(C(b(x, d), c)),
    y = W((((n = {})[m] = v), (n.transform = [((t = {}), (t[f] = w), t)]), n)),
    g = W(I(s, h)),
    V = W(H(g, p)),
    P = V.zIndex,
    O = l(V, ['zIndex']);
...
var N = n.createContext({
  animatedValue: new v(0),
  animatedIndex: new v(0),
  nextIndex: new v(0),
});
function X() {
...
function J(e, t, n, r) {
  ...
  return c([
    m(
      g(e),
      [m(D(a.toValue, n), [y(i.finished, 0), y(a.toValue, n)])],
      [y(i.finished, 0), y(i.time, 0), y(i.velocity, 0), y(a.toValue, n), q(e)]
    ),
    A(e, i, a),
    m(i.finished, [x(e), y(i.position, t)]),
    i.position,
  ]);
}
var K = a.interpolate,
...
(exports.Pager = function(e) {
  var t,
    ...
    de = void 0 === B ? Math.ceil((se - 1) / R) : B,
    ce = W(new v(0)),
    ve = W(new v(0)),
    fe = W(new v(0)),
    me = W(
      s([{ nativeEvent: { translationX: ce, translationY: ve } }], {
        useNativeDriver: !0,
      })
    ),
  ...
  var we = n.useState(he),
    ...
    Ye = W(P(Re, De)),
    Fe = W(new v(0)),
    Ge = W(C(b(f(Oe, be), E(qe, -1)), Te)),
    He = W(new w()),
    We = W(
      c([
        m(
          p(fe, o.State.ACTIVE),
          [m(g(He), x(He)), m(Me, 0, [y(Le, oe), y(Me, 1)]), y(oe, I(Le, Ge))],
          [
            m(Me, [
              y(Me, 0),
              m(Ye, [
                ...
                y(
                  le,
                  m(P(Xe, 0), C(b(I(Ne, Fe), ze), Ae), C(b(h(Ne, Fe), ze), Ae))
                ),
                m(
                  d(u),
                  V([le], function(e) {
  ...
  return r.createElement(
    ...
    r.createElement(a.Code, {
      key: Se,
      exec: m(T(p(be, ye), p(be, Ie)), [], [m(p(ke, 1), y(be, Ie), y(be, ye))]),
    }),
    r.createElement(
      o.PanGestureHandler,
          ...
          r.createElement(
            a.View,
            {
              ...
              onLayout: function(e) {
                ...
                t.width !== ye && ge(t.width), t.height !== Ie && Ve(t.height);
              },
            },
            r.createElement(
              a.View,
